...
program lennard
  ...
  ! Change the teperature here for question 3
  ! -----------------------------------------
  temp=300.d0
  ...
  ! Added seeding below for question 1
  ! Dont forget to define seed1 and seed as integers
  ! ------------------------------------------------
...
subroutine move(u,np,x,y,z,eps,sig,box,hbox,rcut,temp,ar)
  ...
  ! Change the below lines for question 2
  ! -------------------------------------
